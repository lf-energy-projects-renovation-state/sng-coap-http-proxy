...
package org.gxf.standalonenotifyinggateway.coaphttpproxy.adapter.coap.server.configuration
...
import org.gxf.standalonenotifyinggateway.coaphttpproxy.adapter.coap.server.configuration.properties.UdpProperties
...
class CoapConfiguration(val coapProps: CoapProperties, val udpProps: UdpProperties) {
    ...
    @Bean
    fun pskStore(pskRepository: PskRepositoryOutputPort) = AdvancedMultiPskStore()
        .apply {
